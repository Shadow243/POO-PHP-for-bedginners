...
<body>
        ...
        <header class="main_menu_area">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="index.php?p=welcome"><img src="img/logo.png" alt=""></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item active"><a class="nav-link" href="index.php?p=welcome">Home</a></li>
                        <!-- <li class="nav-item"><a class="nav-link" href="#">Pages</a></li> -->
                        <li class="nav-item"><a  href="index.php?p=blog">Blog</a></li>
                        <!-- <li class="nav-item"><a class="nav-link" href="#">Shop</a></li> -->
                        <li class="nav-item"><a class="nav-link" href="index.php?p=contact">Contact</a></li>
                        <li class="nav-item"><a class="nav-link" href="admin.php?p=welcome">Admin</a></li>
                    </ul>
