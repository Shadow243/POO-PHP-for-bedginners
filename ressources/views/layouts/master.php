...
<head>
    ...
    <title>Welcome To | Tonny admin page</title>
    <!-- Favicon-->
...
if(isset($_SESSION['auth'])) {
        $authUser =   App\App::getInstance()->getTable('User')->findById($_SESSION['auth']);
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">SOFT - NAME</a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?= $authUser->name; ?></div>
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <li role="seperator" class="divider"></li>
                            <li><a href="admin.php?p=logout"><i class="material-icons">input</i>Sign Out</a></li>
<!--                            <li><a href="../ressources/views/logout.php"><i class="material-icons">input</i>Sign Out</a></li>-->
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="admin.php?p=category_show" >
                                    <span>Category</span>
                                </a>
                            </li>
                            <li>
                                <a href="admin.php?p=post_show" >
