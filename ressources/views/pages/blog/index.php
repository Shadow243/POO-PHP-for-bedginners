<?php
    ...
    $posts = \App\App::getInstance()->getTable('post')->getByRound(2);
?>
        <!--================Banner Area =================-->
                                ...
                                <div class="static_text2">
                                   ...
                                   <div class="text-right" style="float:right;margin-left: 15px;">
                                       <?php if (isset($_SESSION['auth']) AND !empty($_SESSION['auth'])): ?>
                                           <a href="<?= 'index.php?p=store_like&post='.$post->id ?>" style=""><i class="fa fa-thumbs-o-up" style="margin-left: 15px;"></i>
                                               <?php
                                       ...
                                       <a class="more_btn" href="<?= 'index.php?p=single_blog&post='.$post->id ?>" style="float: left;">Learn More</a>
                                   </div>
                                </div>
                            </div>   <br><br><br/>
                            <?php endforeach; ?>
                                ...
                                <aside class="right_widget r_cat_widget">
                                    ...
                                    <ul>
                                        <?php foreach ($categories as $category): ?>
                                            <li><a href="<?php echo 'index.php?p=blog_search&category='.$category->id ?>"><?= $category->name ?></a></li>
                                        <?php endforeach; ?>
